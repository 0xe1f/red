...
SoundQueue::SoundQueue()
{
    ...
    Debug("SoundQueue: %d audio backends\n", audio_drivers_count);
    ...
    Debug("SoundQueue: %d audio devices\n", audio_devices_count);
    ...
    Log("SoundQueue: %s driver selected\n", SDL_GetCurrentAudioDriver());
...
{
    Log("SoundQueue: Starting with %d Hz, %d channels, %d buffer size, %d buffers ...\n", sample_rate, channel_count, buffer_size, buffer_count);
    ...
    Log("SoundQueue: Desired -  frequency: %d format: f %d s %d be %d sz %d channels: %d samples: %d\n", spec.freq, SDL_AUDIO_ISFLOAT(spec.format), SDL_AUDIO_ISSIGNED(spec.format), SDL_AUDIO_ISBIGENDIAN(spec.format), SDL_AUDIO_BITSIZE(spec.format), spec.channels, spec.samples);
    ...
    Log("SoundQueue: Obtained - frequency: %d format: f %d s %d be %d sz %d channels: %d samples: %d\n", spec.freq, SDL_AUDIO_ISFLOAT(spec.format), SDL_AUDIO_ISSIGNED(spec.format), SDL_AUDIO_ISBIGENDIAN(spec.format), SDL_AUDIO_BITSIZE(spec.format), spec.channels, spec.samples);
